...
import pageTemplatePageGalerieBlade from './routes/gallery';
import pageTemplatePageVirtualGalleryBlade from './routes/gallery-virtual';
...
const routes = new Router({
  ...
  aboutUs,
  pageTemplatePageGalerieBlade,
  pageTemplatePageVirtualGalleryBlade,
});
